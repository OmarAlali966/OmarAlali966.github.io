/* ============================================================
   ...
   1. Copy an object below and add it to ROADMAP in order.
   2. status: "done" | "in-progress" | "planned"
   3. If status is "done", set completionDate \u2014 it will be
      displayed automatically next to the milestone.
   ============================================================ */
...
const ROADMAP = [
  ...
  { id: "ceh", title: "Certified Ethical Hacker (CEH)", category: "cert", status: "planned", completionDate: null },
  { id: "gcih", title: "GIAC Certified Incident Handler (GCIH)", category: "cert", status: "planned", completionDate: null },
  { id: "gsoc", title: "GIAC Security Operations Certified (GSOC)", category: "cert", status: "planned", completionDate: null },
  { id: "gcti", title: "GIAC Cyber Threat Intelligence (GCTI)", category: "cert", status: "planned", completionDate: null },
  { id: "gdat", title: "GIAC Defending Advanced Threats (GDAT)", category: "cert", status: "planned", completionDate: null },
  { id: "ecthpv2", title: "eLearnSecurity Certified Threat Hunting Professional v2 (eCTHPv2)", category: "cert", status: "planned", completionDate: null },
  { id: "ecdfp", title: "eLearnSecurity Certified Digital Forensics Professional (eCDFP)", category: "cert", status: "planned", completionDate: null },
  { id: "osda", title: "OffSec Defense Analyst (OSDA / SOC-200)", category: "cert", status: "planned", completionDate: null },
