...
const LEARNING_PLATFORMS = [
   {
      ...
      completedPaths: [
         ...
         { title: "Security Engineer", status: "completed", progress: 100, difficulty: "Easy", certImage: "assets/certificates/thm-security-engineer.png", certImageAlt: "TryHackMe certificate of completion for the Security Engineer Learning Path, issued to Omar Adel Alali.", summary: "Covers the core skills needed to start a career in security engineering across network, system, and software security.", whatLearned: ["Network security engineering fundamentals", "System hardening and security engineering practices", "Secure software engineering principles", "Risk management and incident response basics"] },
         { title: "DevSecOps", status: "completed", progress: 100, difficulty: "Intermediate", certImage: "assets/certificates/thm-devsecops.png", certImageAlt: "TryHackMe certificate of completion for the DevSecOps Learning Path, issued to Omar Adel Alali.", summary: "Focused on integrating security into the software development lifecycle, from CI/CD pipelines to cloud-native infrastructure.", whatLearned: ["CI/CD pipeline security", "Securing Infrastructure as Code (IaC)", "Container and containerization security", "Applying DevSecOps frameworks in real workflows"] },
         { title: "Web Application Pentesting", status: "completed", progress: 100, difficulty: "Intermediate", certImage: "assets/certificates/thm-web-application-pentesting.png", certImageAlt: "TryHackMe certificate of completion for the Web Application Pentesting Learning Path, issued to Omar Adel Alali.", summary: "Hands-on path covering how to assess web applications for security vulnerabilities from both the server and client side.", whatLearned: ["Identifying common web application vulnerabilities", "Web authentication and session security mechanisms", "Server-side and client-side exploitation techniques", "Recommending remediations for web vulnerabilities"] },
         { title: "AI Security", status: "completed", progress: 100, difficulty: "Medium", certImage: "assets/certificates/thm-ai-security.png", certImageAlt: "TryHackMe certificate of completion for the AI Security Learning Path, issued to Omar Adel Alali.", summary: "A practical foundation in AI security covering how AI systems are built, where they break, and how to attack and defend them.", whatLearned: ["How AI systems are built and deployed", "Attacking and defending LLMs with prompt injection and jailbreaking", "Securing AI supply chains and training data", "Exploiting OWASP LLM vulnerabilities against real agents"] },
         { title: "Advanced Endpoint Investigations", status: "completed", progress: 100, difficulty: "Hard", certImage: "assets/certificates/thm-advanced-endpoint-investigations.png", certImageAlt: "TryHackMe certificate of completion for the Advanced Endpoint Investigations Learning Path, issued to Omar Adel Alali.", summary: "Deep dive into endpoint forensics across Windows, Linux, macOS, and mobile, using memory, disk, and file system analysis.", whatLearned: ["Endpoint investigation techniques across Windows, Linux, macOS, and mobile", "Live memory and cold disk image analysis for signs of compromise", "File system forensics covering MBR, GPT, FAT32, NTFS, and EXT", "Using tools like Volatility, KAPE, SleuthKit, and ALEAPP in real investigations"] },
         { title: "Red Teaming", status: "completed", progress: 100, difficulty: "Hard", certImage: "assets/certificates/thm-red-teaming.png", certImageAlt: "TryHackMe certificate of completion for the Red Teaming Learning Path, issued to Omar Adel Alali.", summary: "Covers the offensive techniques and tradecraft used by Red Team Operators to simulate real-world adversaries.", whatLearned: ["Techniques for gaining initial access to target environments", "Enumeration and persistence on compromised systems", "Evading security solutions and detection controls", "Exploiting Active Directory environments"] }
         ],
      inProgressPaths: [
   ...
   },
   {
      ...
      profileUrl: "https://profile.hackthebox.com/profile/019e29fd-11ce-72e5-a655-41666278e0c6",
      isPlaceholderProfile: false,
      completedPaths: [],
      inProgressPaths: [],
      currentlyLearning: [],
